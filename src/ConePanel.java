...
public class ConePanel extends JPanel{
	...
	//--------------------------------------------------------------------------
	//  Sets up the main GUI components of the Cone Panel.
	//--------------------------------------------------------------------------
	public ConePanel() {
	...
	private class Button2Listener implements ActionListener{
		...
		public void actionPerformed(ActionEvent event) {
			...
			Cone co = new Cone();
			co.setRadius(Double.parseDouble(radius.getText()));
			co.setHeight(Double.parseDouble(height.getText()));
			resultLabel1.setText(Double.toString(co.getVolume()));
			resultLabel2.setText(Double.toString(co.getSurfaceArea()));
